...
class ContextualBandits:
    ...
    def select_exercise(self, data_service: MLDataService, user_id: int, user_word_id: int) -> str:
        ...
        if best_exercise is None:
            ...
            weighted_types = ['multiple_choice_en_to_nl'] * 3 + ['multiple_choice_nl_to_en'] * 3 + ['translation_en_to_nl'] + ['translation_nl_to_en']
    ...
    def update_reward(self, data_service: MLDataService, user_id: int, user_word_id: int, 
                     exercise_type: str, is_correct: bool, response_time: float):
